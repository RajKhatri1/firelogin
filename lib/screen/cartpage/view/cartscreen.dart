...
import 'package:firelogin/screen/cartpage/model/cartmodel.dart';
                           ...
                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Container(
                                height: 25,
                                width: 30,
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(7),color: Colors.deepOrange.shade100),
                                child: const Center(child: Icon(Icons.add,color: Colors.deepOrange,size: 17,)),
                              ),
                              ...
                              Container(
                                ...
                                width: 30,
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(7),color: Colors.deepOrange.shade100),
                                child: const Center(child: Text("-",style: TextStyle(color: Colors.deepOrange,fontSize: 17)),),
                              ),
                              const SizedBox(width: 3,)
                            ],
                          )
